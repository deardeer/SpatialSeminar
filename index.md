...
**简介**：在本次研讨会中，我们承接上一周“我最想分享的一篇学术论文”，推出“我最得力的一个软件/算法/工具”，
相互分享在科研实践中最趁手、最合用、最喜欢的软硬件。旨在让实验室成员进一步了解不同方向的平台、算法、工具的性能特点以及优势和限制，以激发科研灵感，交流实践心得。

**邀请讲者**

- 郑晔 《智能交通信号控制软件SUMO介绍》
- 涂伟 《MIT见闻与体会》
- 蒯希《数据科学分析软件anaconda & kaggle介绍》
- 马丁《空间句法和城市交通软件netlogo介绍》
- 于溪《pajek复杂网络分析软件介绍》
- 李游《GeoSLAM手持激光扫描系统介绍》
- 蓝玉良《微气候模拟软件介绍》
